...
pub fn comandos_disponibles() -> &'static [Comando] {
    &[
        ...
        Comando { id: "editor.copiar", descripcion: "Editor: Copiar al portapapeles" },
        Comando { id: "editor.cortar", descripcion: "Editor: Cortar al portapapeles" },
        Comando { id: "editor.pegar", descripcion: "Editor: Pegar del portapapeles" },
        Comando { id: "editor.alternar_comentario", descripcion: "Editor: Comentar/descomentar líneas" },
        Comando { id: "editor.mover_lineas_arriba", descripcion: "Editor: Mover línea(s) arriba" },
        Comando { id: "editor.mover_lineas_abajo", descripcion: "Editor: Mover línea(s) abajo" },
        Comando { id: "editor.duplicar_lineas", descripcion: "Editor: Duplicar línea(s)" },
        Comando { id: "editor.seleccionar_todo", descripcion: "Selección: Seleccionar todo" },
        Comando { id: "editor.ir_a_linea", descripcion: "Ir: A la línea... (n o n:col)" },
