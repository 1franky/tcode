...
use crate::{statusbar, vista_codigo, vista_markdown, EstadoUi, Paleta};
...
/// para ese archivo (M2, PLAN.md §2: "diagnósticos inline") y, si es
/// Markdown, su [`ModoMarkdown`] (PLAN.md §8).
